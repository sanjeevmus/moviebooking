...
if (isset($_POST['add'])) {
    ...
    if ($_FILES["image"]["name"]) {
        ...
        if (in_array($file_ext, $allowed_extensions)) {
            if ($file_size < 5242880) { // Max file size: 5MB (you can adjust this value)
                ...
                if (move_uploaded_file($file_tmp, $destination)) {
                    ...
                    $sql = "INSERT INTO coming_soon (name, description,reldate, director, image, trailer) VALUES ('$name', '$description', '$reldate', '$director', '$file_name', '$trailer')";
        ...
        $sql = "INSERT INTO coming_soon (name, reldate, director, trailer) VALUES ('$name', '$reldate', '$director', '$trailer')";
        echo 'SQL query: ' . $sql . '<br>'; // Add this line for debugging

...
p.text span {
  ...
  <body>
    ...
    <p class="text">Movie Name: <span id="movieName"></span></p>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#okButton").click(function() {
          ...
          var selectedMovieID = $("#movie").val();

          // Send an AJAX request to retrieve the movie name
          $.ajax({
            type: "POST",
            url: "retrieve_movie.php",
            data: { id: selectedMovieID },
            success: function(response) {
              // Update the movie name in the HTML
              $("#movieName").text(response);
            },
            error: function() {
              console.log("Error retrieving movie name");
            }
          });
        });
      });
